...
*Left: Raster for bursting GID network of 1000 neurons with $\overline{k} = 100$ and $\sigma_k = 20$. Right: Time evolution of voltage and adaptation current for a FID network of 1000 neurons with $k = 100$.*
