...
0. membrane potential caused by stochastic arriving spikes and external current

	$$
	\begin{equation}
	h_\mathrm{PSP}(t) = J_0 \int_0^{\infty} \eta_0(s)A(t-s)ds + \int_0^{\infty}\ki_0(s)I^\mathrm{ext}(t-s)ds
	\end{equation}
	$$
